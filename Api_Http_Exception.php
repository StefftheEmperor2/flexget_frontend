...
/**
 * File for Class Api_Http_Exception
 *
 * @author     Stefan Bischoff
 * @copyright  9Plus GmbH 2020
 ...
 * @subpackage
 **/
class Api_Http_Exception extends Api_Exception
{
	...
	{
		if ($message === '' AND array_key_exists($code, static::$http_status_codes))
		{
			$message = static::$http_status_codes[$code];
		}
